...
# ENV VALUES
load_dotenv()
PAYLOAD_CLIENT_ID = os.getenv("PAYLOAD_CLIENT_ID")
PAYLOAD_CLIENT_SECRET = os.getenv("PAYLOAD_CLIENT_SECRET")
...
def login():
    auth_url = f"{AUTHORIZATION_URL}?client_id={PAYLOAD_CLIENT_ID}&redirect_uri={REDIRECT_URI}&response_type=code"
